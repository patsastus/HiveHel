...
/*   Updated: 2025/05/09 10:53:21 by nraatika         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
[precision: '.' followed by integers][conversion specifier:cspiuxX%]ilz
...
int prec: '.' flag was passed, with or without trailing digits that are read
into precision.

int precision: value gives the minimum number of digits to appear for 
